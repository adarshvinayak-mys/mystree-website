                        ...
                        <nav data-no-booking-intercept="true" className="flex flex-col p-4 gap-4 text-base font-medium text-slate-800 dark:text-slate-200">
                            ...
                            <div className="border-b border-gray-100 dark:border-gray-800">
                                ...
                                >
                                    ...
                                    <Link to="/services/fertility" className={`block py-2 pl-4 text-sm ${location.pathname === '/services/fertility' ? 'text-primary font-bold' : 'text-slate-600 dark:text-gray-400 hover:text-primary'}`} onClick={() => setIsOpen(false)}>Fertility Clinic</Link>
