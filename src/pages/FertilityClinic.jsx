...
export default function FertilityClinic() {
    ...
    return (
        <div className="font-display bg-warm-ivory text-soft-charcoal antialiased selection:bg-warm-coral/30 selection:text-warm-coral relative">
            {/* SEO JSON-LD Schemas */}
            <script
            ...
            </div> {/* End of animate-fade-in-up wrapper */}
